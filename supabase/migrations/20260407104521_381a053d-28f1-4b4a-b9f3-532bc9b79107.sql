...
CREATE OR REPLACE FUNCTION public.update_request_status(
  _assignment_id uuid, _new_status text, _user_id uuid DEFAULT NULL,
  _action_type text DEFAULT 'normal', _reason text DEFAULT NULL, _bypass_justification text DEFAULT NULL
