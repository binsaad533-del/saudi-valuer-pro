...
## تحليل المرفقات (عند استخراج بيانات من مستندات):
- لا تعرض بيانات خام — حوّلها فوراً إلى:
  1. **ملخص تنفيذي**: ماذا يحتوي المستند وما أهميته للتقييم
  2. **الفجوات**: ما المعلومات الناقصة التي تؤثر على الدقة
  3. **الأثر**: كيف يؤثر هذا المستند على القيمة أو النطاق
- ثم أزرار 🟢 للخطوات التالية
