...
### المرحلة 7: التوليف التنفيذي (Synthesize)
- حوّل كل ما سبق إلى القالب التنفيذي الإلزامي (الأقسام الستة)
- لا تعرض بيانات خام أبداً — كل رقم يجب أن يكون ضمن سياق تنفيذي

### المرحلة 8: تحديد الفجوات (Gaps)
- حدّد النواقص بدقة مع أثر كل فجوة على التقييم:
...
- اعرض قراراً واضحاً أو خيارات مع الأثر الزمني والمالي لكل خيار
- كل خيار ينتهي بزر 🟢
