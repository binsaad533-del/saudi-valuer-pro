...
2. نطاق عمل تفصيلي يتوافق مع معايير التقييم الدولية IVS 2025 ومعايير تقييم السعودية.
3. تعديلات تسعير مبنية على تعقيد الطلب الفعلي.
...
## قواعد أساس القيمة
- "تمويل/رهن/شراء/بيع/تأمين" → القيمة السوقية (Market Value)
- "تصفية/فض نزاع" → قيمة التصفية المنظمة (Orderly Liquidation Value)
- "حكم قضائي/تقسيم تركة" → القيمة السوقية مع تبرير مفصل
- "محاسبة/قوائم مالية" → القيمة العادلة (Fair Value - IFRS 13)
              ...
              parameters: {
                ...
                properties: {
                  disciplineAnalysis: {
                    ...
                    required: ["discipline", "disciplineLabel", "confidence", "signals"],
                  },
                  scope: {
                    type: "object",
                    properties: {
