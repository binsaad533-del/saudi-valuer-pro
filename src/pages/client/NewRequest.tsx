          ...
          <div className="space-y-4">
            <Card className="shadow-card">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label className="text-sm">ملاحظات إضافية <span className="text-muted-foreground">(اختياري)</span></Label>
                  <Textarea
                    value={clientInfo.additionalNotes}
                    onChange={(e) => setClientInfo(p => ({ ...p, additionalNotes: e.target.value }))}
                    placeholder="أي ملاحظات أو تعليمات إضافية للمقيّم..."
                    rows={3}
                  />
                </div>
              </CardContent>
            ...
            <div className="flex gap-3">
              <Button variant="outline" onClick={() => setStep("extracted")} className="gap-2">
                <ArrowRight className="w-4 h-4" />
                رجوع
              </Button>
              <Button
