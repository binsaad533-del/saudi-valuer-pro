          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <Card>
              <CardContent className="p-6 space-y-3">
                ...
                <p className="text-[10px] text-muted-foreground">الصق روابط خرائط قوقل لمواقع الأصول (حتى لو كانت مواقع متعددة). يمكن أيضاً استخراج المواقع تلقائياً من الملفات المرفوعة بشرط أن تكون مذكورة بشكل واضح.</p>
                <AssetLocationPicker
