  ...
  return (
    <div className={embedded ? "" : "min-h-screen"} dir="rtl">
      ...
      <div className={embedded ? "space-y-5" : "p-4 md:p-6 max-w-5xl mx-auto space-y-5"}>
        ...
        {/* Extracted Analysis Cards */}
        {scope && !loading && <DisciplineAnalysisCard scope={scope} />}
        {scope && !loading && <PurposeAnalysisCard scope={scope} />}
        {scope && !loading && <BasisOfValueCard scope={scope} />}
        {scope && !loading && <MethodologyAnalysisCard scope={scope} />}
