...
const MOCK_SCOPE: ScopeData = {
  ...
  purposeAnalysis: {
    detectedPurpose: "تمويل بنكي",
    purposeLabel: "تمويل بنكي",
    confidence: 91,
    reason: "وجود خطاب من البنك الأهلي يطلب تقييم العقار لأغراض الرهن العقاري",
    signals: ["خطاب بنكي رسمي", "طلب رهن عقاري", "إشارة للتمويل السكني المدعوم"],
    alternatives: [
      { label: "بيع وشراء", confidence: 45 },
      { label: "تأمين", confidence: 20 },
    ],
  },
  basisOfValueAnalysis: {
    detectedBasis: "القيمة السوقية",
    basisLabel: "القيمة السوقية",
    confidence: 96,
    standard: "IVS 104",
    reason: "غرض التمويل البنكي يتطلب تحديد القيمة السوقية العادلة وفق IVS 104",
    alternatives: [
      { label: "القيمة الاستثمارية", confidence: 30 },
      { label: "قيمة التصفية", confidence: 10 },
    ],
  },
  methodologyAnalysis: {
    primaryApproach: {
      key: "market",
      label: "المقارنة السوقية",
      role: "primary",
      confidence: 92,
      reason: "توفر بيانات مبيعات مماثلة كافية في المنطقة المستهدفة",
    },
    secondaryApproach: {
      key: "cost",
      label: "التكلفة",
      role: "secondary",
      confidence: 78,
      reason: "مناسبة كمنهجية داعمة للتحقق من القيمة خاصة للمباني الحديثة",
    },
    allApproaches: [
      { key: "market", label: "المقارنة السوقية", role: "primary", confidence: 92, reason: "توفر بيانات مبيعات مماثلة كافية في المنطقة" },
      { key: "cost", label: "التكلفة", role: "secondary", confidence: 78, reason: "مناسبة للتحقق من قيمة المباني الحديثة" },
      { key: "income", label: "الدخل", role: "supporting", confidence: 45, reason: "أقل ملاءمة للعقارات السكنية المشغولة من المالك" },
    ],
