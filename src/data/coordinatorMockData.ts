...
export const MOCK_ACTIVITY_LOGS = [
  {
    ...
    action: "create",
    description: "أدخل طلب #VAL-001 نيابة عن العميل أحمد المالكي",
    new_data: { reference_number: "VAL-001", client_name_ar: "أحمد المالكي" },
    old_data: null,
  ...
  },
  {
    ...
    table_name: "valuation_requests",
    action: "update",
    description: "صحّح العنوان والمساحة لطلب #VAL-002",
    new_data: { reference_number: "VAL-002", property_city_ar: "جدة", land_area: 1800 },
    old_data: { reference_number: "VAL-002", property_city_ar: "جده", land_area: null },
  ...
  },
  {
    ...
    action: "create",
    description: "أرسل رسالة تنبيه للعميل محمد الدوسري لإكمال البيانات",
    new_data: { reference_number: "VAL-003", content: "نأمل إكمال البيانات المطلوبة في أقرب وقت..." },
    old_data: null,
  ...
  },
  {
    ...
    table_name: "valuation_requests",
    action: "create",
    description: "أدخل طلب #VAL-004 نيابة عن العميلة فاطمة الشهري",
    new_data: { reference_number: "VAL-004", client_name_ar: "فاطمة الشهري" },
    old_data: null,
  ...
  },
  {
    ...
    table_name: "valuation_requests",
    action: "update",
    description: "صحّح نوع العقار لطلب #VAL-005",
    new_data: { reference_number: "VAL-005", property_type: "warehouse" },
    old_data: { reference_number: "VAL-005", property_type: "commercial_building" },
    created_at: daysAgo(1),
  },
  {
    id: "log6",
    table_name: "valuation_requests",
    action: "update",
    description: "راجع وأكد بيانات طلب #VAL-002 قبل إصدار التقرير",
    new_data: { reference_number: "VAL-002", status: "report_issued" },
    old_data: { reference_number: "VAL-002", status: "draft_report_ready" },
